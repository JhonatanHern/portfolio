...
import { Mail, ChevronDown, ShieldAlert } from 'lucide-react';
  ...
  return (
    <Section id="home" className="items-start relative">
      ...
      >
        <Link 
          to="/security-tool" 
          className="flex items-center gap-2 bg-violet-600/20 hover:bg-violet-600/40 border border-violet-500/30 px-6 py-3 rounded-full text-white font-medium transition-all duration-300 backdrop-blur-sm shadow-[0_0_15px_rgba(139,92,246,0.3)] hover:shadow-[0_0_25px_rgba(139,92,246,0.5)]"
        >
          <ShieldAlert className="w-5 h-5 text-violet-300" />
          Explore my Web Scanning Pipeline
        </Link>
      </motion.div>
